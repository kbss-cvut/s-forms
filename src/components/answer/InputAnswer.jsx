...
const NUMERIC_DATATYPES = [
  ...
  Constants.XSD.FLOAT,
  Constants.XSD.POSITIVE_FLOAT,
  Constants.XSD.NEGATIVE_FLOAT,
];
...
const InputAnswer = (props) => {
  ...
  return React.createElement(inputComponent, {
    ...InputPropertiesResolver.resolveInputProperties(
      question,
      value,
      componentsOptions
    ),
    ...
    onFocus: (e) => {
      if (props.sparql) {
        ...
        YASQE.Autocompleters.prefixes.appendPrefixIfNeeded = function (
          yasqe,
          completerName
        ) {
